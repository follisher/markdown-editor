export default {
  ...
  humorous: {
    ...
    title: {
      h1: 'text-align:center;font-size:22px;margin-top:50px;margin-bottom:20px;color:#333',
      h2: 'border-left-width:6px;border-left-style:solid;border-left-color:#ff5500;border-right-width:6px;border-right-style:solid;border-right-color:#ff5500;text-align:center;font-size:22px;margin-top:50px;margin-bottom:20px;color:#383838;background:#f2f2f2;padding-left:10px;padding-right:14px;padding-top:4px;padding-bottom:4px;',
    ...
    paragraph: 'font-size:15px;color:#585858;line-height:1.75;text-align:center;margin-top:30px;margin-bottom:30px',
    image: {
      wrap: 'margin-bottom:20px;text-align:center',
